...
(function() {
  ...
  const DICTIONARY = {
    hi: {
      ...
      'Daily Cash Given': 'दैनिक दिए गए नकद',
      'Daily Cash Given Log': 'दैनिक नकद देने का लॉग',
    ...
    mr: {
      ...
      'Daily Cash Given': 'दररोज दिलेली रोख',
      'Daily Cash Given Log': 'दररोज दिलेल्या रोखीची नोंद',
